...
CREATE TABLE "User" (
    ...
    "Description" character varying(510) NULL,
    "FaxNumber" character varying(10) NULL,
    CONSTRAINT "PK_User" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_User_Addresses_AddressId" FOREIGN KEY ("AddressId") REFERENCES "Addresses" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "Comments" (
    ...
    CONSTRAINT "FK_Comments_User_UserId" FOREIGN KEY ("UserId") REFERENCES "User" ("Id") ON DELETE CASCADE
);

CREATE TABLE "Orders" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "OrderedTime" timestamp with time zone NOT NULL,
    ...
    CONSTRAINT "FK_Orders_User_CustomerId" FOREIGN KEY ("CustomerId") REFERENCES "User" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "Product" (
    ...
    "Publisher" character varying(50) NULL,
    ...
    CONSTRAINT "FK_Product_User_AuthorId" FOREIGN KEY ("AuthorId") REFERENCES "User" ("Id") ON DELETE CASCADE
);
...
CREATE TABLE "OrderItems" (
    ...
    CONSTRAINT "FK_OrderItems_Product_ProductId" FOREIGN KEY ("ProductId") REFERENCES "Product" ("Id") ON DELETE CASCADE
);
...
VALUES ('20220627160611_Initial', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "Comments" DROP CONSTRAINT "FK_Comments_User_UserId";

ALTER TABLE "OrderItems" DROP CONSTRAINT "FK_OrderItems_Orders_OrderId";

ALTER TABLE "OrderItems" DROP CONSTRAINT "FK_OrderItems_Product_ProductId";

ALTER TABLE "Orders" DROP CONSTRAINT "FK_Orders_User_CustomerId";

ALTER TABLE "User" DROP CONSTRAINT "FK_User_Addresses_AddressId";
...
ALTER TABLE "OrderItems" RENAME TO "OrderItem";

ALTER TABLE "Comments" RENAME TO "Comment";

ALTER TABLE "Addresses" RENAME TO "Address";

ALTER INDEX "IX_Orders_CustomerId" RENAME TO "IX_Order_CustomerId";

ALTER INDEX "IX_OrderItems_ProductId" RENAME TO "IX_OrderItem_ProductId";

ALTER INDEX "IX_OrderItems_OrderId" RENAME TO "IX_OrderItem_OrderId";

ALTER INDEX "IX_Comments_UserId" RENAME TO "IX_Comment_UserId";
...
ALTER TABLE "Comment" ADD CONSTRAINT "FK_Comment_User_UserId" FOREIGN KEY ("UserId") REFERENCES "User" ("Id") ON DELETE CASCADE;

ALTER TABLE "Order" ADD CONSTRAINT "FK_Order_User_CustomerId" FOREIGN KEY ("CustomerId") REFERENCES "User" ("Id") ON DELETE CASCADE;

ALTER TABLE "OrderItem" ADD CONSTRAINT "FK_OrderItem_Order_OrderId" FOREIGN KEY ("OrderId") REFERENCES "Order" ("Id");

ALTER TABLE "OrderItem" ADD CONSTRAINT "FK_OrderItem_Product_ProductId" FOREIGN KEY ("ProductId") REFERENCES "Product" ("Id") ON DELETE CASCADE;

ALTER TABLE "User" ADD CONSTRAINT "FK_User_Address_AddressId" FOREIGN KEY ("AddressId") REFERENCES "Address" ("Id") ON DELETE CASCADE;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220627161239_MakeTableNamesConsistent', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "Comment" DROP CONSTRAINT "FK_Comment_User_UserId";

ALTER TABLE "Order" DROP CONSTRAINT "FK_Order_User_CustomerId";
...
ALTER TABLE "Product" DROP CONSTRAINT "FK_Product_User_AuthorId";

ALTER TABLE "User" DROP CONSTRAINT "FK_User_Address_AddressId";

ALTER TABLE "User" DROP CONSTRAINT "PK_User";

ALTER TABLE "Product" DROP CONSTRAINT "PK_Product";

DROP INDEX "IX_Product_AuthorId";
...
ALTER TABLE "User" DROP COLUMN "FaxNumber";

ALTER TABLE "Product" DROP COLUMN "AuthorId";

ALTER TABLE "Product" DROP COLUMN "Discriminator";

ALTER TABLE "Product" DROP COLUMN "Genre";

ALTER TABLE "Product" DROP COLUMN "ISBN";

ALTER TABLE "Product" DROP COLUMN "Language";

ALTER TABLE "Product" DROP COLUMN "Pages";

ALTER TABLE "Product" DROP COLUMN "PublicationDate";

ALTER TABLE "Product" DROP COLUMN "Publisher";
...
ALTER TABLE "OrderItem" RENAME TO "OrderItems";
...
ALTER INDEX "IX_User_AddressId" RENAME TO "IX_Users_AddressId";

ALTER INDEX "IX_OrderItem_ProductId" RENAME TO "IX_OrderItems_ProductId";

ALTER INDEX "IX_OrderItem_OrderId" RENAME TO "IX_OrderItems_OrderId";

ALTER INDEX "IX_Order_CustomerId" RENAME TO "IX_Orders_CustomerId";

ALTER INDEX "IX_Comment_UserId" RENAME TO "IX_Comments_UserId";
...
CREATE TABLE "Authors" (
    ...
    CONSTRAINT "FK_Authors_Users_Id" FOREIGN KEY ("Id") REFERENCES "Users" ("Id") ON DELETE CASCADE
);

CREATE TABLE "Customers" (
    "Id" integer NOT NULL,
    "FaxNumber" character varying(10) NOT NULL,
...
ALTER TABLE "Users" ADD CONSTRAINT "FK_Users_Addresses_AddressId" FOREIGN KEY ("AddressId") REFERENCES "Addresses" ("Id") ON DELETE CASCADE;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220628093624_MoveToTPT', '6.0.5');
...
ALTER TABLE "Orders" RENAME COLUMN "OrderedTime" TO "UpdatedOn";

ALTER TABLE "Books" RENAME COLUMN "Pages" TO "PageCount";

ALTER TABLE "Addresses" RENAME COLUMN "Name" TO "Street";

ALTER TABLE "Users" ALTER COLUMN "BirthDate" TYPE date;

ALTER TABLE "Products" ALTER COLUMN "StartingPrice" TYPE double precision;

ALTER TABLE "Products" ALTER COLUMN "FinalPrice" TYPE double precision;

ALTER TABLE "Orders" ALTER COLUMN "TotalPrice" TYPE double precision;

ALTER TABLE "Orders" ADD "CreatedOn" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';

ALTER TABLE "Books" ALTER COLUMN "Language" TYPE character varying(50);

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220628201513_OverallImprovements', '6.0.5');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220629111743_AdaptForLogin', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "Users" ALTER COLUMN "BirthDate" TYPE timestamp with time zone;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220629114921_PurgeDateOnly', '6.0.5');
...
ALTER TABLE "Comments" ADD "ConversationId" integer NULL;

CREATE TABLE "Conversations" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "AuthorId" integer NOT NULL,
    CONSTRAINT "PK_Conversations" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_Conversations_Authors_AuthorId" FOREIGN KEY ("AuthorId") REFERENCES "Authors" ("Id") ON DELETE CASCADE
);

CREATE INDEX "IX_Comments_ConversationId" ON "Comments" ("ConversationId");

CREATE INDEX "IX_Conversations_AuthorId" ON "Conversations" ("AuthorId");

ALTER TABLE "Comments" ADD CONSTRAINT "FK_Comments_Conversations_ConversationId" FOREIGN KEY ("ConversationId") REFERENCES "Conversations" ("Id");

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220702100038_AddConversationAndUserRole', '6.0.5');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220702151609_ForumAdded', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "Comments" DROP CONSTRAINT "FK_Comments_Conversations_ConversationId";

DROP TABLE "Conversations";

DROP INDEX "IX_Comments_ConversationId";

ALTER TABLE "Comments" DROP COLUMN "ConversationId";

ALTER TABLE "Comments" ADD "AuthorHostId" integer NOT NULL DEFAULT 0;

CREATE INDEX "IX_Comments_AuthorHostId" ON "Comments" ("AuthorHostId");

ALTER TABLE "Comments" ADD CONSTRAINT "FK_Comments_Authors_AuthorHostId" FOREIGN KEY ("AuthorHostId") REFERENCES "Authors" ("Id") ON DELETE CASCADE;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220703101338_ConversationDeleted', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "Addresses" DROP COLUMN "IsActive";

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220703134036_MultipleAddressNotPossibleAnymore', '6.0.5');
...
ALTER TABLE "Users" ADD CONSTRAINT "AK_Users_PhoneNumber" UNIQUE ("PhoneNumber");

ALTER TABLE "Users" ADD CONSTRAINT "AK_Users_Username" UNIQUE ("Username");

CREATE UNIQUE INDEX "IX_Books_ISBN" ON "Books" ("ISBN");

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220703143421_UniqueConstraintsAdded', '6.0.5');
...
CREATE TABLE "BookReviews" (
    ...
    CONSTRAINT "FK_BookReviews_Books_BookId" FOREIGN KEY ("BookId") REFERENCES "Books" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_BookReviews_Users_UserId" FOREIGN KEY ("UserId") REFERENCES "Users" ("Id") ON DELETE CASCADE
);
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220704191000_UserAddedToBookReview', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "BookReviews" RENAME COLUMN "Comment" TO "Content";

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220705122356_BookReviewFromCommentToContent', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "Books" ALTER COLUMN "Summary" TYPE text;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220708211204_RemoveLimitationOnBookSummaryLength', '6.0.5');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220708213606_FixBookIdAlways0Error', '6.0.5');

COMMIT;

START TRANSACTION;

ALTER TABLE "Products" ALTER COLUMN "Title" TYPE character varying(254);

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220709082845_SetHigherProductTitleLimit', '6.0.5');
